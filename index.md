...
venue: "Central Clinical School, Monash University"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Lecture Theatre, Level 5, The Alfred Centre, 99 Commercial Road, Prahan, Melbourne"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "-37.846468,144.984459"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "Nov 12-13, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "10:00am-5:00pm, 9:00am-4:30pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2019-09-12      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2019-09-13        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Nick Wong", "Andrew Perry"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Adele Barugahare", "Sarah Williams", "Tyrone Chen", "Sneha Jambagi", "Nitika Kandhari"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: "https://pad.carpentries.org/2019-11-12-monash-genomics"            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite: 73060615267          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
<p id="requirements">
  ...
  Mac, Linux, or Windows operating system (not a tablet, Chromebook, etc.) that they have administrative privileges on and can access the internet through EDUROAM. They should have a few specific software packages installed (listed <a href="#setup">below</a>).
</p>
